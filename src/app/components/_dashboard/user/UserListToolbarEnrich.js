...
export default function UserListToolbarEnrich({ numSelected, filterName, onFilterName, parent }) {
  ...
  return (
    ...
    >
      ...
      >
        <Box>
          <Tooltip title="Add new enrichment" placement="top" arrow>
            <IconButton
              className="squareIconButton"
              onClick={(e) => navigate(`${GLOBAL_PATH}/${parent}/add`)}
            >
